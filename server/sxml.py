...
def html_from_sexpr(sexpr) -> str:
    """Return HTML equivalent to the specified symbolic expression `sexpr`,
    or return `None` if `sexpr` does not represent an XML-compatible element.
    """
